...
1. Organizer accesses ${md.link("the calendar", `https://t.me/${this.botName}/my93Tantia`)} \
...
Go to ${md.link("the calendar", `https://t.me/${this.botName}/my93Tantia`)} to get started`;
